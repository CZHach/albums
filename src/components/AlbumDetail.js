...
const AlbumDetail = ({ album }) => {
    ...
    return (
        <Card>
            ...
            <CardSection>
                {/* pass a navigateToUrl function as a prop to the Button component so that 
                the Button component is as generic as possible.
                Additionally, pass in text as a child prop.
                */}
                <Button navigateToUrl={() => Linking.openURL(url)} >
                    Buy Now
                </Button>
            </CardSection>
        </Card>
